 ...
 *
 * @property Perfil $fkPerfil
 * @property Perfil $fkAuthAssignment
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'fkAuthAssignment.item_name' => 'Rol',
        ];
    }
    ...
    */
    ...
    {
        return $this->hasOne(Perfil::className(), ['fk_user' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getFkAuthAssignment()
    {
