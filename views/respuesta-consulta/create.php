...
<div class="respuesta-consulta-create">
    ...
    <p>Recuerde que una vez publicada la respuesta se dará por cerrada la consulta, 
    	si tiene dudas consulte con el usuario en la sección de dudas antes de publicar en esta sección.
    </p>
