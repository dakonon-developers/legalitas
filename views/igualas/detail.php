    ...
    <div class="table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>Suscribirse</td>
                    <td><?= Html::a('Suscribirse', ['subscribe', 'id' => $model->id, 'plan' => 1], ['class' => 'btn btn-primary']) ?></td>
                    <td><?= Html::a('Suscribirse', ['subscribe', 'id' => $model->id, 'plan' => 2], ['class' => 'btn btn-primary']) ?></td>
                    <td><?= Html::a('Suscribirse', ['subscribe', 'id' => $model->id, 'plan' => 3], ['class' => 'btn btn-primary']) ?></td>
                </tr>
            </tbody>
        </table>
    </div>
