...
class m170813_001804_igualas extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%igualas}}',[
            ...
            'slim_duracion' => $this->integer()->defaultValue(3),
            'med_duracion' => $this->integer()->defaultValue(7),
            'plus_duracion' => $this->integer()->defaultValue(10),
            'slim' => $this->float()->notNull(),
            'med' => $this->float()->notNull(),
            'plus' => $this->float()->notNull(),
            'estado' => $this->integer()->defaultValue(1),
